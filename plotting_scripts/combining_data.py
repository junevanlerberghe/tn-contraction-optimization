...
df_default_slurm_d3 = pd.read_csv("outputs/slurm_data/d3_info.csv", sep=';')
df_default_slurm_d3 = df_default_slurm_d3[["distance", "q_shor", "representation", "contraction_time", "operations"]]
...
df_default_slurm_d5 = pd.read_csv("outputs/slurm_data/d5_info.csv", sep=';')
df_default_slurm_d5 = df_default_slurm_d5[["distance", "q_shor", "representation", "contraction_time", "operations"]]

df_default_slurm_d7 = pd.read_csv("outputs/slurm_data/d7_info.csv", sep=';')
df_default_slurm_d7 = df_default_slurm_d7[["distance", "q_shor", "representation", "contraction_time", "operations"]]
...
df_default_total = pd.concat([
    df_default_ctg,
    df_default_slurm
], ignore_index=True)

df_default_total.to_csv("outputs/combined_data/combined_data.csv", sep=';', index=False)